	...
	return (
		<div className={styles.container}>
			...
			<p className={styles.text}>
				...
				We&apos;re working on fixing it faster than you can say &apos;Chewbacca.&apos;
				🛠️🌌 In the meantime, grab a cup of blue milk and relax. We&apos;ll have
				everything back in order soon. Thanks for your patience, brave Rebel!
				#Error404RebelAlliance
			</p>
			<p className={styles.text}>
